...
class Player(Entity):
	def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
		...
		# stats
		self.stats = {'health': 125, 'energy':60, 'attack': 10, 'magic': 4, 'speed': 5}
		self.max_stats = {'health': 400, 'energy': 100, 'attack': 20, 'magic' : 10, 'speed': 5}
		...
		# import a sound
		self.weapon_attack_sound = pygame.mixer.Sound('../audio/metal-hit.mp3')
